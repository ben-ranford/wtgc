...
printf '%s' "$keep_content" > "$test_root/foreign/keep.txt"
...
printf '%s' "$keep_content" > "$test_root/forged-marker/keep.txt"
...
printf '%s' "$keep_content" > "$test_root/foreign-release/keep.txt"
...
printf '%s' "$keep_content" > "$test_root/sentinel/keep.txt"
